...
class Test_2aii(GradedTestCase):
  ...
  def test_4(self):
    ...
    results_match = True
    if not np.allclose(student_grad['W1'], solution_grad['W1'], atol=0, rtol=0.75):
      print('W1 weight did not match expected result')
      print(student_grad['W1'])
      print(solution_grad['W1'])
      results_match = False

    if not np.allclose(student_grad['b1'], solution_grad['b1'], atol=0, rtol=0.75):
      print(f'b1 bias did not match expected result')
      print(student_grad['b1'])
      print(solution_grad['b1'])
      results_match = False

    if not np.allclose(student_grad['W2'], solution_grad['W2'], atol=0, rtol=0.75):
      print('W2 weight did not match expected result')
      print(student_grad['W2'])
      print(solution_grad['W2'])
      results_match = False

    if not np.allclose(student_grad['b2'], solution_grad['b2'], atol=0, rtol=0.75):
      print('b2 bias did not match expected result')
      print(student_grad['b2'])
      print(solution_grad['b2'])
      results_match = False
